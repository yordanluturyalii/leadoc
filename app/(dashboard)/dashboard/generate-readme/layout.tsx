      ...
      <div className="py-3">
        <div className="flex flex-col md:flex-row gap-2">
          <div
            ...
            <h1 className="font-semibold">Travel-app</h1>
          </div>

          <div className="flex-1 flex flex-col items-start gap-2 md:flex-row md:justify-between">
            <div className="flex items-center gap-4">
              <Button type='button' isDisable={false} isDark={true} className='px-3 py-2 md:p-3'>Generate
                README</Button>
              <div className='flex gap-1 items-center'>
                <Image src='/coins.svg' alt='coins' width={20} height={20}/>
                <span className='font-semibold text-body-xl'>5 Credits</span>
              </div>
            </div>
            <div
                className="max-md:w-full flex items-center gap-[10px] bg-white border border-neutral-200 p-3 rounded-xl">
