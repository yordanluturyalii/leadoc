    ...
    <main className='overflow-hidden xl:pt-20 pt-16 bg-neutral-50'>
      ...
      <section className='px-5 py-20 flex flex-col gap-24 items-center md:gap-9'>
        ...
        <div className='text-center flex flex-col gap-5 items-center'>
          <h1 className="text-title-md md:text-5xl lg:text-[64px] lg:w-[920px]">Create your README in seconds.</h1>
      ...
      {/* Futures Section */}
      <section id='features' className="futures py-20 px-5 md:px-10 flex flex-col items-center bg-[#F5F5F5]">
      ...
      <section className="py-20 px-5 flex flex-col gap-20 items-center md:px-10">
        ...
        <span className="flex gap-3 text-title-xxs md:text-title-sm">
          Something unclear?
          <Link href='/contact' className='text-purple-600'>Feel free to ask.</Link>
        </span>
      </section>
